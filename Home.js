...
const Home = ({ title, content, author, imageUrl }) => {
                    ...
                    {data.map((data, index) => (
                        data.date >= today ?
                            <div className="blog-card">
                                <img src="https://placehold.co/600x200" alt="Blog Cover" className="blog-image" />
                                <div className="blog-info">
                                    <h2 className='blog-head'>{data.name}</h2>
                                    <p className='blog-descp'>{data.descp}</p>
                                    <p className='blog-descp'>Date: {data.date}</p>
                                    <p className="blog-venue">Venue: {data.venue}</p>
                                </div>
                            </div> : null
                    ))}
                </div>
